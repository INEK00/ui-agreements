              ...
              >
                <MultiColumnList
                  ...
                  columnMapping={{
                    ...
                    startDate: (
                      <FormattedMessage id="ui-agreements.agreementPeriods.periodStart" />
                    ),
                    endDate: (
                      <FormattedMessage id="ui-agreements.agreementPeriods.periodEnd" />
                    ),
                    currency: (
                      <FormattedMessage id="ui-agreements.agreements.currency" />
                    ),
                    price: (
                      <FormattedMessage id="ui-agreements.agreements.price" />
                    ),
                    consortia: (
                  ...
                  formatter={{
                    ...
                    endDate: (a) =>
                      a.endDate ? <FormattedUTCDate value={a.endDate} /> : "",
                    currency: (a) => {
                      const currencyTypes = a.customProperties?.CurrencyType;
                      return currencyTypes instanceof Array
                        ? currencyTypes[0].value.label
                        : "";
                    },
                    price: (a) => {
                    ...
                    consortia: (a) => {
                      ...
                      return consortias instanceof Array
                        ? consortias[0]?.value?.label
                        : "";
                    },
