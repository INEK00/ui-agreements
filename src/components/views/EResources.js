...
import { MultiColumnList, SearchField, Pane, Icon, Button, ButtonGroup, PaneMenu } from '@folio/stripes/components';
...
import { getResourceIdentifier, getSiblingIdentifier, EResourceType } from '@folio/stripes-erm-components';
									...
									<form onSubmit={onSubmitSearch}>
										<IfEResourcesEnabled>
											<ButtonGroup fullWidth>
												<Button id='clickable-nav-agreements' to={urls.agreements()}>
													<FormattedMessage id='ui-agreements.agreements' />
												</Button>
												<Button buttonStyle='primary' id='clickable-nav-eresources'>
							...
							<Pane
								...
								<MultiColumnList
									...
									formatter={{
										name: (e) => {
											return (
												<AppIcon app='agreements' iconAlignment='baseline' iconKey='eresource' size='small'>
