	...
	getActionMenu = ({ onToggle }) => (
		<>
			<IfPermission perm='ui-agreements.agreements.edit'>
				<Button buttonStyle='dropdownItem' id='clickable-dropdown-edit-agreement' onClick={this.props.handlers.onEdit}>
					<Icon icon='edit'>
		...
		return (
			<>
				...
				<ConfirmationModal
					...
					message={
						<SafeHTMLMessage
							id='ui-agreements.agreements.deleteConfirmMessage'
							values={{ name: data.agreement?.name }}
						/>
					}
