...
import { Col, FormattedUTCDate, Headline, KeyValue, MultiColumnList, NoValue, Row } from '@folio/stripes/components';
	...
	render() {
		...
		return (
			<div data-test-agreement-info>
				...
				<Row>
					<Col xs={4}>
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.consortia' />}>
							<div data-test-agreement-customProperties>
								{agreement?.customProperties?.Consortia ? (
									agreement?.customProperties?.Consortia[0].value.label
								) : (
									<NoValue />
								)}
							</div>
					...
					<Col xs={4}>
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.currency' />}>
							<div data-test-agreement-customProperties>
								{agreement?.customProperties?.CurrencyType ? (
									agreement?.customProperties?.CurrencyType[0].value.label
								) : (
									<NoValue />
								)}
							</div>
					...
					<Col xs={4}>
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.price' />}>
							<div data-test-agreement-customProperties>
								{agreement?.customProperties?.Price ? agreement?.customProperties?.Price[0].value : <NoValue />}
							</div>
						</KeyValue>
					</Col>
				</Row>
				<Row>
						...
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.cancellationDeadline' />}>
							<div data-test-agreement-cancellation-deadline>
								{agreement.cancellationDeadline ? (
									<FormattedUTCDate value={agreement.cancellationDeadline} />
								) : (
									<NoValue />
								)}
							</div>
					...
					<Col xs={4}>
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.renewalPriority' />}>
							<div data-test-agreement-renewal-priority>{agreement?.renewalPriority?.label ?? <NoValue />}</div>
						</KeyValue>
					</Col>
					<Col xs={4}>
						<KeyValue label={<FormattedMessage id='ui-agreements.agreements.isPerpetual' />}>
							<div data-test-agreement-is-perpetual>{agreement?.isPerpetual?.label ?? <NoValue />}</div>
						</KeyValue>
					</Col>
				</Row>
					...
					<Row>
						<Col xs={4}>
							<KeyValue label={<FormattedMessage id='ui-agreements.agreements.agreementStatus' />}>
								<div data-test-agreement-status>{agreement?.agreementStatus?.label ?? <NoValue />}</div>
							</KeyValue>
						</Col>
						<Col xs={4}>
							<KeyValue label={<FormattedMessage id='ui-agreements.agreements.reasonForClosure' />}>
								<div data-test-agreement-reason-for-closure>{agreement?.reasonForClosure?.label ?? <NoValue />}</div>
							</KeyValue>
						</Col>
					</Row>
				)}
				{agreement?.alternateNames?.length !== 0 && (
					<MultiColumnList
						columnMapping={{
							name: <FormattedMessage id='ui-agreements.alternativeNames' />,
						}}
