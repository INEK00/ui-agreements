...
import { Col, FormattedUTCDate, KeyValue, NoValue, Row } from '@folio/stripes/components';
			...
			<Row className={css.agreementHeader}>
				<Col xs={2}>
					<KeyValue label={<FormattedMessage id='ui-agreements.agreementPeriods.periodStart' />}>
						<div data-test-agreement-start-date>{startDate ? <FormattedUTCDate value={startDate} /> : <NoValue />}</div>
					</KeyValue>
				</Col>
				<Col xs={2}>
					<KeyValue label={<FormattedMessage id='ui-agreements.agreementPeriods.periodEnd' />}>
						<div data-test-agreement-end-date>{endDate ? <FormattedUTCDate value={endDate} /> : <NoValue />}</div>
					</KeyValue>
				</Col>
				<Col xs={2}>
				...
				<Col xs={3}>
					<KeyValue label={<FormattedMessage id='ui-agreements.agreements.vendor' />}>
						<div data-test-agreement-vendor-name>{this.renderVendor()}</div>
					</KeyValue>
				</Col>
			</Row>
		);
